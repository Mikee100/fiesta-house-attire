        ...
        >
          ...
          <div className="about-fade" ref={ref} style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            {[
              ...
              <>The gowns in our atelier are <strong>complimentary photoshoot looks</strong> curated specifically for maternity photography. We do not operate as an off-the-rack dress store; instead, we provide a private wardrobe of over 300 designer gowns and trailing silks for you to select and wear during your session.</>,
