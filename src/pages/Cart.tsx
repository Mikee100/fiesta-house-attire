          ...
          {cart.length === 0 ? (
            <div style={{ 
              ...
              <div>
                ...
                <Link to="/gift-vouchers" className="btn btn-primary" style={{ borderRadius: "100px" }}>
                  Browse Packages
                </Link>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-12 lg:gap-16 items-start fade-in">
              ...
              <div className="flex flex-col gap-6">
                ...
                <Link to="/gift-vouchers" className="flex items-center gap-2 text-[var(--magenta)] font-bold mt-4 hover:gap-3 transition-all">
